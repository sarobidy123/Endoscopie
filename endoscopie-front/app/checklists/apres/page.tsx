...
export default function ChecklistApresPage() {
  return (
    <AppShell>
      <main className="lg:ml-64 pt-24 pb-32 px-4 lg:px-8 flex justify-center min-h-[1024px] bg-background text-on-surface">
        <div className="max-w-[56rem] w-full space-y-8">
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-slate-500 flex items-center gap-2">
                  ...
                  ID: 458-992-331 • Né le 12/05/1974 (49 ans)
                </p>
              </div>
            </div>
          ...
          <div className="pt-8 space-y-6">
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center">
              <a href="/checklists/avant" className="w-full md:w-auto px-8 py-3 rounded-xl border border-slate-200 text-slate-600 font-bold hover:bg-slate-50 transition-all flex items-center justify-center gap-2 group">
                <span className="material-symbols-outlined text-xl group-hover:-translate-x-1 transition-transform">arrow_back</span>
                Retour à la check-list avant anesthésique
              </a>
              <a href="/rapport" className="flex-1 w-full bg-gradient-to-r from-blue-900 to-blue-700 text-white font-bold py-4 rounded-xl shadow-xl shadow-blue-900/20 hover:shadow-blue-900/30 active:scale-[0.98] transition-all flex items-center justify-center gap-3">
                <span className="material-symbols-outlined">check_circle</span>
                Valider et Terminer la Checklist
              </a>
            </div>
          </div>
        </div>
      ...
      <div className="fixed top-1/4 -right-24 w-96 h-96 bg-blue-100/50 rounded-full blur-[100px] -z-10" />
      <div className="fixed bottom-0 -left-24 w-80 h-80 bg-slate-200/50 rounded-full blur-[100px] -z-10" />
    </AppShell>
  );
}
